...
public class Exercise3_Product
{
    ...
    public Exercise3_Product(String PRODUCT, String productName, String CATEGORY, double unitPrice, int quantityInStock) {
    ...
    public void displayProductInfo() {
        System.out.println("Product: " + productName + " [" + PRODUCT + "]");
